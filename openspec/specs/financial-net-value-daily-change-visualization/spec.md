# financial-net-value-daily-change-visualization Specification

## Purpose
TBD - created by archiving change add-financial-daily-change-column. Update Purpose after archive.
## Requirements
